...
public class GetMazeDBList : MonoBehaviour
{
    ...
    private string preloadMazeOne = $"{{\"mazeId\":13,\"title\":\"RoundUp\",\"creator\":\"Scott\",\"mazeTextureFileName\":\"{Path.Combine(Application.streamingAssetsPath, "PreLoadedMazes/RoundUp.JPEG")}\",\"invertToUseBlackLines\":true,\"startPositionRatio\":{{\"x\":0.0925000011920929,\"y\":0.08500000089406967}},\"endPositionRatio\":{{\"x\":0.8949999809265137,\"y\":0.9200000166893005}},\"numberOfPlayThroughs\":0}}";
    private string preloadMazeTwo = $"{{\"mazeId\":7,\"title\":\"Blue Stripe\",\"creator\":\"Scott\",\"mazeTextureFileName\":\"{Path.Combine(Application.streamingAssetsPath, "PreLoadedMazes/BlueStripe.JPEG")}\",\"invertToUseBlackLines\":true,\"startPositionRatio\":{{\"x\":0.029999999329447748,\"y\":0.7799999713897705}},\"endPositionRatio\":{{\"x\":0.7749999761581421,\"y\":0.6424999833106995}},\"numberOfPlayThroughs\":0}}";
    ...
    private string preloadMazeFour = $"{{\"mazeId\":9,\"title\":\"Trapped\",\"creator\":\"Scott\",\"mazeTextureFileName\":\"{Path.Combine(Application.streamingAssetsPath, "PreLoadedMazes/HandDrawn.JPG")}\",\"invertToUseBlackLines\":true,\"startPositionRatio\":{{\"x\":0.4025000035762787,\"y\":0.13500000536441804}},\"endPositionRatio\":{{\"x\":0.6474999785423279,\"y\":0.9024999737739563}},\"numberOfPlayThroughs\":0}}";
    private string preloadMazeFive = $"{{\"mazeId\":10,\"title\":\"In Orbit\",\"creator\":\"Scott\",\"mazeTextureFileName\":\"{Path.Combine(Application.streamingAssetsPath, "PreLoadedMazes/Orbits.JPEG")}\",\"invertToUseBlackLines\":true,\"startPositionRatio\":{{\"x\":0.042500000447034839,\"y\":0.03500000014901161}},\"endPositionRatio\":{{\"x\":0.16750000417232514,\"y\":0.8725000023841858}},\"numberOfPlayThroughs\":0}}";
    ...
    IEnumerator GetAndInstantiateMazePanelsCoroutine(bool use_SO = false)
    {
        ...
        if (MazeList.Mazes.Count == 0)   // If we are starting fresh - lets pop sone pre-loaded mazes in
        {
            ...
            Debug.Log($"combined path: {Path.Combine(Application.streamingAssetsPath, "PreLoadedMazes/RoundUp.JPEG")}");
